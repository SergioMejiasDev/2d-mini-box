...
public class Tetromino : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.A)) // La pieza se mueve a la izquierda.
        {
        ...
        else if (Input.GetKeyDown(KeyCode.D)) // La pieza se mueve a la derecha.
        {
            transform.position += new Vector3(1, 0, 0);
        ...
        else if (Input.GetKeyDown(KeyCode.W)) // La pieza rota hacia la derecha.
        {
        ...
        else if (Input.GetKeyDown(KeyCode.S) || Time.time - lastFall >= 1) // La pieza desciende un nivel hacia abajo.
        {
