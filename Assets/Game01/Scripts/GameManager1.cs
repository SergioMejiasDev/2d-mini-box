...
public class GameManager1 : MonoBehaviour
{
    ...
    public void StartGame()
    {
        ...
        // Desactivamos todos los paneles que no sean necesarios (menú, pausa y Game Over).

        panelMenu.SetActive(false);
        panelPause.SetActive(false);
        panelGameOver.SetActive(false);

        // Activamos al jugador y los generadores (monedas y enemigos).
    ...
    {
        // La puntuación aumenta en un punto y se actualiza el panel con la nueva puntuación.
