...
public class GhostMovement : MonoBehaviour
{
    ...
    {
        // Como se utiliza la misma clase para los 4 fantasmas, se utilizarán delegados para sincronizar los diferentes eventos.
    ...
    {
        // Al desactivarse el fantasma, los delegados dejarán de afectarle.
